...
const SETUPS = [
  {
    id: "breakout",
    label: "Breakout",
    description: "Breaking above 20d high with volume surge",
    icon: TrendingUp,
  },
  {
    id: "pullback",
    label: "Pullback to SMA20",
    description: "Retracing to SMA20 in uptrend (close > SMA50)",
    icon: ArrowRight,
  },
  {
    id: "oversold_bounce",
    label: "Oversold Bounce",
    description: "RSI below 35 — reversal from oversold zone",
    icon: Target,
  },
  {
    id: "golden_cross",
    label: "Golden Cross",
    description: "SMA50 crosses above SMA200 within 5 sessions",
    icon: Crosshair,
  },
];
